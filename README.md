...
Jornada Viagens is a static website developed to present tourist destinations through a clean, simple, and visually organized interface. The project was created as part of front-end development practice, focusing on semantic HTML structure, CSS layout organization, and version control using Git and GitHub.
...
This will display the website locally so you can explore the interface and tourist destinations presented in the project.
...
Manual testing can be performed by opening the project in a browser and navigating through the sections of the website to verify layout responsiveness and visual organization.

Example:

```
Open index.html and navigate through the destination sections.
```
